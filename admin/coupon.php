...
if ($_POST['action'] == 'deletedata') {
    ...
    $conn->delete('coupons', "id = :id", $data, 'no');
    exit;
}
...
if (count($result) == 0) {
    ...
    foreach ($result as $value) {
        ...
        <div class='col'><a href='addCoupon.php?id=" . $value['id'] . "' type='button' id='udp" . $value['id'] . "' class='udp btn btn-success upd'>UPDATE</a></div>
        ...
        <main class='position-relative my-3'>
            <div class="row d-flex justify-content-between mb-3">
                <div class="col-12 d-flex justify-content-end">
                    <a class="btn btn-outline-success" href="<?php echo SITE_URL; ?>eCommerce/admin/addCoupon.php"
                        role="button">Add Coupon</a>
                </div>
                <!-- customer list tabel -->
...
<script>
    ...
    $(document).on('click', ".deltheme", function () {
        ...
        Swal.fire({
            title: 'Do you want to delete this poupon?',
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire('coupon is not deletd!!', '', 'info')
            }
        })
    });
</script>
